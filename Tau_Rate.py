...
if Cmp4x4 == False:
	saveWhere = 'plots/July26Taus/Tau4x8DiTauRateE'+str(Ethresh)+'H'+str(Hthresh)+selection+'RlxVeto'+str(TauVetoRlx)+'OffIso'+str(turnOffIso)+'OffVeto'+str(turnOffTauVeto)+'Iso'+str(ISOTHRESHOLD)+'L1pTVal'+str(l1ptVal)
if drawL1Rlx == True:
...
if selection == "NoVeto":
       ...
       vetoCut = '(l1gTauVeto[0]==0||pt[0]>'+str(turnOffTauVeto)+')&&(l1gTauVetoNeighbor[0]==0)&&(l1gTauVeto[1]==0||pt[1]>'+str(turnOffTauVeto)+')&&(l1gTauVetoNeighbor[1]==0)'
...
# UCT Rlx + Isolation by hand
 ...
 latex.DrawLatex(0.8,0.6, latexStrIso)
 if drawL1Rlx == True:
