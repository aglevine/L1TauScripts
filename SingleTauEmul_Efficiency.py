...
def make_resolution(ntuple,ntuple_iso,binning,recoPtCut,l1PtCutLow,l1PtCutHigh,extraCut):
 ...
 if (do2DRes):
 	varString = '(pt[0]-genpt[0])/pt[0]:'+var2D+'[0]'
 else:
	if (L1Denom):
		varString = '(pt[0]-'+str(L1CalibFactor)+'*genpt[0])/('+str(L1CalibFactor)+'*genpt[0])'
	else:
		varString = '(pt[0]-'+str(L1CalibFactor)+'*genpt[0])/(pt[0])'
 rlxRes = make_plot(ntuple,varString,'pt[0]>=4&&genpt[0]>='+str(l1PtCutLow)+'&&genpt[0]<'+str(l1PtCutHigh)+'&&genmatches[0]>=0'+extraCut,binning)
 isoRes = make_plot(ntuple_iso,varString,'pt[0]>=4&&genpt[0]>='+str(l1PtCutLow)+'&&genpt[0]<'+str(l1PtCutHigh)+'&&genmatches[0]>=0'+extraCut,binning)
...
# Current Relaxed
 cut_L1_rlx=cutD_rlx+'&&'+l1PtCut+'&& genmatches[0]>-1'
...
#+'&&pt[0] <'+str(recoPtHigh)+')',
 #recoPtCut='1',
 l1PtCut='(genpt[0] >= '+str(l1PtValLow)+'&&genpt[0]<'+str(l1PtValHigh)+')',
 extraCut='&&eta[0]>-2.5&&eta[0]<2.5&&geneta[0]>-2.5&&geneta[0]<2.5',
)
compare_efficiencies(
 #'pt[0]:pt[1]',
 "pt[0]",
 ...
 #recoPtCut='1',
 l1PtCut='(genpt[0] >='+ str(l1PtVal)+')',
 extraCut='&&eta[0]>-2.5&&eta[0]<2.5&&geneta[0]>'+str(etaLow)+'&&geneta[0]<'+str(etaHigh),
)
compare_efficiencies(
 #'pt[0]:pt[1]',
 "pt[0]",
 ...
 #recoPtCut='1',
 #l1PtCut='((genpt[0] >='+ str(36/1.255)+'&&abs(geneta[0])<0.9)||(genpt[0] >='+ str(36/1.208)+'&&abs(geneta[0])<1.4&&abs(geneta[0])>=0.9)||(genpt[0] >='+ str(36/1.185)+'&&abs(geneta[0])<2.5&&abs(geneta[0])>=1.4))',
 l1PtCut='((genpt[0] >='+ str(44/1.163)+'&&abs(geneta[0])<0.9)||(genpt[0] >='+ str(44/1.122)+'&&abs(geneta[0])<1.4&&abs(geneta[0])>=0.9)||(genpt[0] >='+ str(44/1.070)+'&&abs(geneta[0])<2.5&&abs(geneta[0])>=1.4))',
 
 #l1PtCut = '(genpt[0]>='+str(36/1.255)+')',
 #l1PtCut = '(genpt[0]>='+str(36)+')',
 extraCut='&&eta[0]>-2.5&&eta[0]<2.5&&geneta[0]>-2.5&&geneta[0]<2.5',
)
'''
make_resolution(eff_ntuple,
                ...
                #extraCut = '&&eta[0]>-2.5&&eta[0]<2.5&&geneta[0]>'+str(etaResLow)+'&&geneta[0]<' + str(etaResHigh)
                extraCut = '&&abs(eta[0])<=2.5&&abs(geneta[0])<=2.5&&abs(geneta[0])>='+str(etaResLow)+'&&abs(geneta[0])<'+str(etaResHigh)
) 
