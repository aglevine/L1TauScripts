...
saveWhere = 'EmulatorTestingNov/BinnedTausNewCalibEOBIB/ThirdPassNewCalibSingleTauEffMatchFixThreshFixJan280Point1Iso'
...
def make_resolution(ntuple,ntuple_iso,binning,recoPtCut,l1PtCutLow,l1PtCutHigh,extraCut):
 info = 'EmulResPlotNewCalib_reco'+str(recoPtCut)+'_l1Low'+str(l1ptResLow)+'_l1High'+str(l1ptResHigh)+'_etaLow'+str(etaResLow)+'_etaHigh'+str(etaResHigh)+'_L1CalibFactor'+str(L1CalibFactor)
 if (do2DRes):
...
compare_efficiencies(
 ...
 eff_ntuple_NoDoubling,
 eff_iso_ntuple_NoDoubling,
 recoPtCut = '(pt[0] >= '+str(recoPtVal)+'&&eta[0]>='+str(etaLow)+'&&eta[0]<'+str(etaHigh)+')',
 #recoPtCut='1',
 #l1PtCut='(L1Matchedpt[0] >='+ str(36/1.31)+')',
 l1PtCut='((L1Matchedpt[0] >='+ str(36/1.131)+'&&abs(L1Matchedeta[0])<0.9)||(L1Matchedpt[0] >='+ str(36/1.061)+'&&abs(L1Matchedeta[0])<1.4&&abs(L1Matchedeta[0])>=0.9)||(L1Matchedpt[0] >='+ str(36/1.050)+'&&abs(L1Matchedeta[0])<2.5&&abs(L1Matchedeta[0])>=1.4))',
 extraCut='&&eta[0]>-2.5&&eta[0]<2.5&&L1Matchedeta[0]>-2.5&&L1Matchedeta[0]<2.5',
)
'''
